package com.hasanfurkan.yemekkitabi
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments.let {
            ...
            if(gelenBilgi.equals("menudengeldim")){
                ...
                val gorselSecmeAp = BitmapFactory.decodeResource(context?.resources, R.drawable.secimgorsel)
                imageView.setImageBitmap(gorselSecmeAp)
            }else{
                button.visibility = View.VISIBLE
...
//                    izin verilmediyse izin istenecek
                    requestPermissions(arrayOf(Manifest.permission.READ_EXTERNAL_STORAGE), 1)
                }else{
//                    izin zaten verilmis istemeden galeriye git
